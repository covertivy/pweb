# This is a dom-xss scanner from the xsssniper project: "https://github.com/gbrindisi/xsssniper/blob/master/core/domscanner.py"
        ...
        try:
            ...
            while index <= len(response) - 1:
                ...
                if (response[index] == '" ' or response[index] == "' ") and insrc:
                    ...
                    continue
                if (
                    (response[index] == '">' or response[index] == "'>")
                    and insrc
                    and intag
                ):
                    insrc = False
