...
CONFIG_FILE_PATH = os.path.join(THIS_FOLDER, CONFIG_FILE_NAME)  # Create path of config file. (name can be changed)
...
def fetch_plugins():
    """
    Function obtains the config file containing the path of each plugin,
...
def generate_check_device():
    """
    Function generates the Check Device file and imports the plugins that were collected,
