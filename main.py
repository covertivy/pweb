...
def main(url="http://192.168.56.101/dvwa/"):
    try:
        ...
        get_plugins.write_checker(plugin_path_list)  # If there is no problem with the plugins
        # (The write_checker() function doesn't need exceptions)
        print(COLOR_MANAGER.BOLD + COLOR_MANAGER.UNDERLINE + "Start checking:" + COLOR_MANAGER.ENDC)
